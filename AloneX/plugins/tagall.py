...
TAGMES = [ " **𝐇𝐞𝐲 𝐁𝐚𝐛𝐲 𝐊𝐚𝐡𝐚 𝐇𝐨🥱** ",
           ...
           " ** [ @Chinky_432 ] 𝐈𝐧𝐤𝐨 𝐀𝐧𝐤𝐡 𝐔𝐭𝐡𝐚 𝐊𝐞 𝐃𝐞𝐤𝐡 𝐧𝐚 𝐌𝐚𝐭 𝐉𝐚𝐧𝐧 𝐉𝐚𝐲𝐞𝐠𝐚 𝐓𝐮𝐦𝐡𝐚𝐫𝐚🤫** ",
           " **𝐀𝐧𝐤𝐚 𝐏𝐲𝐚𝐚𝐫𝐢 𝐊𝐮 𝐊𝐚𝐮𝐭𝐡𝐢 𝐃𝐞𝐤𝐡𝐢𝐜𝐡𝐚 𝐊𝐢[ @Evil_king_011 ]🤭** ",
           " **𝐘𝐞 𝐊𝐲𝐚 𝐒𝐡𝐞𝐫 𝐇𝐚𝐢  @Eagleafk 👀** ",
           " **𝐘𝐞 𝐀𝐦𝐚𝐫𝐚 𝐂𝐮𝐭𝐞 𝐏𝐞𝐫𝐬𝐨𝐧 [ @Tomyyy_07 ] 𝐁𝐞𝐥𝐢𝐞𝐯𝐞 𝐇𝐚𝐮𝐧𝐢 𝐉𝐚𝐝𝐢 𝐃𝐦 𝐊𝐚𝐫𝐢𝐤𝐢 𝐏𝐚𝐜𝐡𝐚𝐫𝐚☺️** ",
           " **𝐘𝐞 𝐇𝐞𝐥𝐞 𝐀𝐦𝐚𝐫𝐚 𝐁𝐚𝐝𝐚 𝐁𝐇𝐚𝐢[ @silent5k ]😄** ",
           " **𝐘𝐞 𝐏𝐚𝐫𝐚 𝐀𝐦𝐚𝐫𝐚 𝐆𝐢𝐫𝐥 𝐎𝐰𝐧𝐞𝐫[ @Banshika_Cutie_Pie_143 ]😌** ",
           " **𝐓𝐚𝐦𝐚 𝐆𝐟 𝐍𝐮𝐦𝐛𝐞𝐫 𝐃𝐢𝐚** ",
           ]

@app.on_message(filters.command(["Awajenikaal", "tagalll", "tagmember"], prefixes=["/", "@", "#"]))
...
async def cancel_spam(client, message):
    ...
    if not is_admin:
        ...
        try:
            ...
            pass
        return await message.reply("😢 KN PAI STOP KALA J G HAUCHI TAMARA 😢")

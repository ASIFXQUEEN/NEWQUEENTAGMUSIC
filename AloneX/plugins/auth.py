...
from AloneX.utils.database import (delete_authuser, get_authuser,
                                       get_authuser_names,
                                       save_authuser)
from AloneX.utils.decorators import AdminActual
from AloneX.utils.formatters import int_to_alpha
...
async def auth(client, message: Message, _):
    if not message.reply_to_message:
        ...
        if token not in _check:
            ...
            await message.reply_sticker("CAACAgUAAxkBAAELEUplj8lxN9nniCivrlhUF9EtaX37aAACcAYAAlDWyVSevja3qth4qjQE")

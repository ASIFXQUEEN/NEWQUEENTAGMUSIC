...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("AloneX/assets/circle.png")
            ...
            image4.text((960, 10), "ALone Music", fill="white", font = font1, align ="left")
            ...
            image4.text((670, 350), text=title1[1], fill="white", stroke_width=1, stroke_fill="green", font = font3, align ="left") 

...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ᴀʟᴏɴᴇ ダ ᴍᴜsɪᴄ")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/TeamAloneOp/AloneXMusic")
...
YOUTUBE_IMG_URL = "AloneX/assets/alonex.jpeg"
